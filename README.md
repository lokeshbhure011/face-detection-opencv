...
-> Haar cascades are trained on lots of positive (face) and negative (non-face) images. 

-> The model detects patterns and can spot faces in new images or video frames.
